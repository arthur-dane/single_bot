...
PICS = (environ.get('PICS' ,'https://te.legra.ph/file/c990b598eb5874756793d.jpg')).split()
BOT_START_TIME = time()
...
RemoveBG_API = environ.get("RemoveBG_API", False)
WELCOM_PIC = environ.get("WELCOM_PIC", False)
