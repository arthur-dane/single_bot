    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='<b>CHAT NOT ALLOWED 🐞\n\nMy Admin Has Restricted Me From Working Here! If you want to know more about it then Contact Owner...</b>',
        ...
        await message.reply_text(
            text=f"<b>›› Thanks For Adding Me In Your Group.\n›› Do Not Forget Me To Promote me as Admin.\n›› If You Are Having Any Doubt Regarding Me Then Click the Below Button ..⚡⚡.</b>",
            reply_markup=reply_markup)
    else:
